    ...
    <div className="space-y-6 pb-20 lg:pb-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className={`flex items-center gap-1 text-sm ${config.textColor}`}>
              <StatusIcon className="w-4 h-4" />
              {config.label}
            </span>
            <span className="text-gray-500">·</span>
            <span className="text-sm text-gray-500">{post.platform.replace('_', ' ')}</span>
          </div>
        </div>
        {canEdit && (
          <Link
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-67-dark rounded-2xl border border-67-gray p-4">
            ...
            <p className="text-gray-300 whitespace-pre-wrap">{post.caption || 'No caption'}</p>
            {post.hashtags && (
              <p className="mt-3 text-67-gold">{post.hashtags}</p>
            )}
          </div>
      ...
      {showRejectModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
          <div className="w-full max-w-md bg-67-dark rounded-2xl border border-67-gray p-6 animate-fadeIn">
